...
BOOKING_LINK = os.environ.get('BOOKING_LINK', 'mailto:anna@writeitgreat.com?subject=Social%20Media%20Strategy%20%E2%80%94%20Let%E2%80%99s%20Talk')
...
def send_social_strategy_email(to_email: str, name: str,
    ...
    <div style="max-width:600px;margin:0 auto;padding:24px;">
        ...
        <p>Want to take it further? Email Anna to set up a free 30-minute call:</p>
        <p><a href="{BOOKING_LINK}" style="display:inline-block;padding:12px 24px;
            ...
            font-weight:bold;">Email Anna to Book a Call →</a></p>
...
def admin_social_lead_followup(lead_id):
    ...
    <div style="max-width:600px;margin:0 auto;padding:24px;">
        ...
        <p><a href="{BOOKING_LINK}" style="display:inline-block;padding:12px 24px;
            background:#2D1B69;color:white;text-decoration:none;border-radius:5px;
            font-weight:bold;">Email Anna to set up a call →</a></p>
